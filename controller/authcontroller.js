...
const { GetUserByRefreshToken, generateAccessToken, GetUserByID, Logout, CheckUserByDecodedToken, generateRefreshToken, RefreshTokenComparer, UserCreate, updateRefreshToken, IsUserExistByEmail, GetUserByEmail, generateResetToken } = require("../app/user.app");
const bcrypt = require('bcryptjs');
const contentValidation = require("../utils/validation/contentValidation");
...
class AuthController {
    ...
    async linksender(req, res, next) {
        try {
            ...
            const resetToken = generateResetToken({ email, Id: user.Id });
